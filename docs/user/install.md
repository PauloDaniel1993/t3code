...
| Kimi        | [Kimi Code CLI](https://www.kimi.com/code/docs/en/kimi-code-cli/guides/getting-started.html)               | `kimi`             | `kimi login`                       |
...
Codex and Claude are on by default. Cursor, Grok Build, Kimi, OpenCode, and Antigravity are off by
