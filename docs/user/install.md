...
| Kimi        | Install [Kimi Code CLI](https://www.kimi.com/code/docs/en/kimi-code-cli/guides/getting-started.html), then run `kimi login`. |
...
[Claude](./providers-claude.md), [Kimi](./kimi.md), [OpenCode](./providers-opencode.md), and
