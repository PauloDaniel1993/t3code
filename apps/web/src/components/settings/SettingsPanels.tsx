...
function GeneralDisplaySettings() {
  const settings = usePrimarySettings();
  const updateSettings = useUpdatePrimarySettings();
  ...
  return (
    <SettingsPageContainer>
      {/* Color scheme lives on the Appearance page, not here: the fork's
          Mode section owns it with previews. Upstream's flat theme Select
          would be a second control writing the same state. */}
      <SettingsSection id="appearance" title="Display">
        <SettingsRow
