...
function AttachmentBrowserPreview(props: {
  ...
  const resource = useMemo(
    () => buildAttachmentBrowserPreviewResource(props.attachment, props.threadId),
    [props.attachment.id, props.attachment.mimeType, props.attachment.name, props.threadId],
  );
  const assetUrl = useAssetUrlState(props.environmentId, resource);
