...
describe("MessagesTimeline", () => {
  ...
  it("renders mixed attachments as image thumbnails and accessible file cards", async () => {
    const { MessagesTimeline } = await import("./MessagesTimeline");
  ...
  it("keeps preview annotation rendering image-only in mixed messages", async () => {
    const { MessagesTimeline } = await import("./MessagesTimeline");
