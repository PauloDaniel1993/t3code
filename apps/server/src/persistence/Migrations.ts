...
import Migration0033 from "./Migrations/033_ProjectionThreadSessionRecovery.ts";
import Migration0034 from "./Migrations/034_DatabaseCompactionJournal.ts";
...
export const migrationEntries = [
  ...
  [33, "ProjectionThreadSessionRecovery", Migration0033],
  [34, "DatabaseCompactionJournal", Migration0034],
] as const;
