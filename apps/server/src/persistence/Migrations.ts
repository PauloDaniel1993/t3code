...
import Migration0033 from "./Migrations/033_ProjectionThreadMessageModelReroute.ts";
import Migration0999 from "./Migrations/999_ProviderThreadHandoff.ts";
...
export const migrationEntries = [
  ...
  [33, "ProjectionThreadMessageModelReroute", Migration0033],
  [999, "ProviderThreadHandoff", Migration0999],
] as const;
