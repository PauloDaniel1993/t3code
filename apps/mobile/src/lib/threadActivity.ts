...
// query, the server projector, and the web comparator. The shared pending-
// request reducer separately treats terminal request events as final.
...
/** Canonical mobile activity order before deriving feed presentation state. */
