...
const WsOrchestrationGetActivityHistoryRpc = Rpc.make(ORCHESTRATION_WS_METHODS.getActivityHistory, {
...
export const WsSubscribeWayfinderMapsRpc = Rpc.make(WS_METHODS.subscribeWayfinderMaps, {
