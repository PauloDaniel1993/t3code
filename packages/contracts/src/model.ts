...
export const DEFAULT_DEEPSEEK_HANDOFF_COMPRESSION_MODEL = "deepseek-v4-flash";
...
export const DEFAULT_MODEL_BY_PROVIDER: Partial<Record<ProviderDriverKind, string>> = {
  ...
  [DEEPSEEK_DRIVER_KIND]: DEFAULT_DEEPSEEK_MODEL,
};
...
> = {
  ...
  [OPENCODE_DRIVER_KIND]: "openai/gpt-5",
  [DEEPSEEK_DRIVER_KIND]: DEFAULT_DEEPSEEK_HANDOFF_COMPRESSION_MODEL,
};
